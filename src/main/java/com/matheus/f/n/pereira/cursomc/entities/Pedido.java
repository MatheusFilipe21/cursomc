...
public class Pedido implements Serializable {
	private static final long serialVersionUID = 4053694777053584582L;
	...
	public String toString() {
		...
		SimpleDateFormat dataFormatadaBR = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");
		StringBuilder builder = new StringBuilder();
		builder.append("Número do Pedido: ");
		builder.append(getId());
		builder.append(", Instante: ");
		builder.append(dataFormatadaBR.format(getInstante()));
